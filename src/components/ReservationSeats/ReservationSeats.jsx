...
const ReservationSeats = () => {
    ...
    const handleContinue = () => {
        ...
        if (selectedSeat) {
            ...
            if (selectedSeat) {
                ...
                fetch("https://proyecto-tic-equipo2east.onrender.com/reservation", requestOptions)
    ...
    const fetchSeats = async () => {
        try {
            const response = await axios.get(`https://proyecto-tic-equipo2east.onrender.com/seats`, {
                params: {
                    numRoom: numRoom,
                    cinemaId,
                    datetime: dateTime
    ...
    useEffect(() => {
        ...
        const fetchMovieData = async () => {
            ...
            try {
                const response = await axios.get(`https://proyecto-tic-equipo2east.onrender.com/function/`+functionId);
